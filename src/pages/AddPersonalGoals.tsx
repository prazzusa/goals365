...
const AddPersonalGoals = () => {
  ...
  const loadGoalsForDate = useCallback(async (date: Date) => {
    ...
    try {
      ...
      toast.error("Failed to load personal goals");
    } finally {
      setIsLoading(false);
    }
  }, [user]);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-border px-4 py-4">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-foreground flex-1">Personal Goals</h1>
        </div>
      </div>
      ...
      <div className="px-4 py-6 space-y-6 pb-24 max-w-lg mx-auto relative">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-foreground">Add Personal Goals</h2>
          </div>
        ...
        >
          ...
          {goals.length === 0 ? (
            <div className="bg-card border border-border rounded-2xl p-8 text-center">
              ...
              <p className="text-muted-foreground text-sm">No personal goals for this day</p>
                ...
                {goals.map((goal) => (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      goal.completed ? "border-rose-200 bg-rose-50/50" : "border-border"
                    )}
                  >
                    <button
